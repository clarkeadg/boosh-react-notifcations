...
var create = function create() {
  ...
  var getNotifications = function getNotifications(q) {
  ...
  var updateNotifications = function updateNotifications(id, q) {
    var accessToken = (0, _booshReactAuth.getAccessToken)();
    if (accessToken) api.setHeader('Authorization', 'Bearer ' + accessToken);
    console.log('updateNotifications', id, q);
    return api.put('notifications/' + id, q);
  };
